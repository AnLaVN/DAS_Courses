...
<body>
			...
			<div class="m-0 p-0 col-lg-5 col-xl-4 position-relative row d-none d-lg-block" style="min-height: 150px;">
				...
				<div class="sticky-top">
					<div class="col-11 position-absolute pt-5" style="top: 25%; left: 50%; transform: translateX(-50%)">
						<button type="button" class="btn btn-lg btn-outline-primary mt-4 mb-3 w-100" onclick="location.href='/CourseMaterial.html'">Tham Gia</button>
	...
	<div style="min-height: 100vh;">
		...
		<!-- Default Card -->
		<div class="mx-0 mt-4 mb-5 mx-md-5 px-0 d-block d-lg-none">
			<div class="card">
				<img class="card-img-top" src="${Course.anhmota}">
				<div class="card-body">
					<button type="button" class="btn btn-lg btn-outline-primary m-0 my-3 mb-5 w-100" onclick="location.href='/CourseMaterial.html'">Tham Gia</button>
					<h5 class="card-title">${Course.tenkhoahoc}</h5>
		...
		<!-- Ratting Course -->
		<div class="mx-0 mt-4 mb-5 mx-md-5 px-0 row">
			<div class="m-0 p-0 col-lg-7 col-xl-8 accordion">
