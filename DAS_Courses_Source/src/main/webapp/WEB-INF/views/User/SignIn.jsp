...
<<<<<<< HEAD
    <title><spring:message code="user.signin.webtitle"/></title>
=======
    <link rel="icon" type="image/x-icon" href="/Image/Logo.png">
    <title><spring:message code="user.signin.signin"/></title>
...
<body id="BGImage" class="d-flex flex-column h-100">
	...
	<div class="toast-container position-fixed top-0 end-0 p-3"  >
		<div id="Toast" class="toast align-items-center" role="alert">
			<div class="d-flex">
				<div class="toast-body text-danger"><spring:message code="user.signin.toast"/></div>
