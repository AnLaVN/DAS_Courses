                                ...
                                <div id="Sentence${loop.index}" class="accordion-collapse collapse${loop.index==0?' show':''}" data-bs-parent="#ExamSentencesDelete">
                                    <div class="accordion-body row m-0 p-0 p-md-2">
                                        ...
                                        <div class="col-12 col-md-6 my-2">
                                            ...
                                            <div class="col-12 col-md-6 my-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="AnswerOfSentence${loop.index}" value="B" id="AnswerBOfSentence${loop.index}" required> <label class="form-check-label" for="AnswerBOfSentence${loop.index}">B.
												${cauhoi.dapanb}</label>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6 my-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="AnswerOfSentence${loop.index}" value="C" id="AnswerCOfSentence${loop.index}" required> <label class="form-check-label" for="AnswerCOfSentence${loop.index}">C.
												${cauhoi.dapanc}</label>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6 my-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="AnswerOfSentence${loop.index}" value="D" id="AnswerDOfSentence${loop.index}" required> <label class="form-check-label" for="AnswerDOfSentence${loop.index}">D.
												${cauhoi.dapand}</label>
                                                </div>
                                            </div>
