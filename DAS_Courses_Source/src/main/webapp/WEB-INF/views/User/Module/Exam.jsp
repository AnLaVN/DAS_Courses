...
<body>
	...
	<div class="m-0 mx-md-5 my-4 p-0 row">
		...
		<div class="col-12 col-lg-8 m-0 p-0">
			<form class="needs-validation" name="ExamForm" novalidate ng-init="Validation()" action="#" method="post">
				...
				<button type="submit" class="btn btn-lg btn-primary my-4 w-100 fw-bolder fs-5">${Mark > 0 ? 'LÀM LẠI' : 'HOÀN THÀNH'}</button>
			</form>
		</div>
	</div>
	...
	<div class="toast-container position-fixed bottom-0 end-0 p-3"  >
		<div id="Toast" class="toast align-items-center" role="alert">
			<div class="d-flex">
				<div class="toast-body text-danger fw-bold fs-6">Vui lòng hoàn thành tất cả câu hỏi trước khi nộp bài</div>
