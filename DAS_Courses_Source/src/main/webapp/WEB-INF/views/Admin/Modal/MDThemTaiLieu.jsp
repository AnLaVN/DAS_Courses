...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
			<form method="post" id="formAddTaiLieu" novalidate="novalidate" >
				...
				<div class="mb-3">
					...
					<input type="text" name="tentainguyen" maxlength="128" class="form-control" required="required" id="resource-name" placeholder="Nhập tên tài nguyên">
				...
				<div class="mb-3">
					...
					<textarea class="form-control" maxlength="1024" name="mota" id="description" rows="4" placeholder="Nhập mô tả"></textarea>
				</div>
